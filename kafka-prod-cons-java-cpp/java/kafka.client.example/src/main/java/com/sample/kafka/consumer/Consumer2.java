	...
	private void runSimpleConsumer() throws Exception {
        ...
        while (true) {
            ...
            for (MessageAndOffset messageAndOffset : fetchResponse.messageSet(topic, partition)) {
                ...
                CustomValueDeserializer valueDeserializer = new CustomValueDeserializer();
                
                SampleMessage message =  (SampleMessage)valueDeserializer.fromBytes(bytes);
                
                System.out.println("SimpleConsumer message: offest: " + String.valueOf(messageAndOffset.offset()) + " and message:  " + message);
