...
import com.beep02.ps.datastream.impl.LastDealsSource;
...
@Service("system-last-deals-service")
@StreamDataSources(LastDealsSource.class)
public class SystemLastDealsService extends SystemService{
}
